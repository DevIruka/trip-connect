...
const Header = () => {
  ...
  const bgColor = pathname === '/' ? 'bg-Gray9Fill' : 'bg-white';
  return shouldHideHeader && !isDesktop ? null : (
    <>
      <div className={`${bgColor} w-screen flex place-content-center`}>
        <div className="flex sticky top-0 h-[56px] md:h-[84px] z-50 w-full justify-between py-[13.5px] md:py-0 px-[20px] max-w-[1200px] md:px-9">
          <Link href="/" className="flex place-content-center">
            ...
            <Desktop>
              <Image src={biglogo} alt="헤이로컬 로고" width={84} height={84} />
            </Desktop>
          </Link>
