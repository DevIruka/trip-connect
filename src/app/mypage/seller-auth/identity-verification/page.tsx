    ...
    <div className="h-full w-full px-5 bg-white">
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className="flex w-[335px] h-[52px] px-[16px] py-[14px] leading-[52px] flex-col items-start gap-[10px] self-stretch rounded-lg border border-gray-300 bg-white overflow-hidden text-black text-sm font-medium leading-[140%] tracking-[-0.28px] whitespace-nowrap"
        >
