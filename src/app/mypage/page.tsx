      ...
      <div className="px-5">
        ...
        {isModalOpen && (
          <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-black bg-opacity-50 z-[50]">
            <div className="flex flex-col w-[335px] px-[20px] py-[10px] items-center gap-[16px] rounded-[12px] bg-white">
              <div className="flex justify-center items-center gap-[90px] py-[8px] relative w-full h-[50px]">
                {/* 프로필 편집 텍스트 */}
                <h2 className="absolute left-1/2 transform -translate-x-1/2 m-0 text-black font-pretendard text-[16px] font-semibold leading-[140%] tracking-[-0.32px]">
                  프로필 편집
                </h2>
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-none border-none cursor-pointer"
                >
                  <Image
              ...
              <div className="flex flex-col items-center mb-4">
                {/* 프로필 이미지 */}
                <div className="w-[295px] h-[100px] flex justify-center items-center mb-[16px]">
                  <div className="w-[103px] h-[100px] flex justify-center items-center relative overflow-hidden rounded-full">
                    <label
